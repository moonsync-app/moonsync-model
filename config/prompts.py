...
STRICTLY FOLLOW - Do not use the phrase - 'Given that you're in the _____ phase', 'Since you're in the ______ phase', etc. to refer to the user's menstrual phase if you have used it once in the chat history.
